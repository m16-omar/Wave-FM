    ...
    <div className="w-full select-none overflow-hidden pb-16">
      ...
      <section className="w-full py-8 sm:py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
          {/* Left: Rounded Image Box featuring new advertise with us image */}
          <div className="lg:col-span-6 rounded-[32px] overflow-hidden relative shadow-2xl border border-white/10 min-h-[380px] sm:min-h-[460px] group bg-neutral-900">
            <img
              src={ASSET_IMAGES.advertiseWithUs}
              alt="Advertise With Us - Imole 106.3 FM"
          ...
          <div className="lg:col-span-6 bg-brand-yellow text-black rounded-[32px] p-8 sm:p-12 shadow-2xl flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black/10 text-black text-xs font-black uppercase tracking-wider">
                <Radio className="w-3.5 h-3.5" />
                <span>COMMERCIAL BROADCASTING</span>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs sm:text-sm font-semibold text-black/85 leading-relaxed">
                  Are you looking to reach an engaged indigenous and urban audience to grow your business? Ìmọ́lẹ̀ 106.3 FM offers affordable promotional plans and jingle rotations tailored for brands, SMEs, and corporate campaigns across Lagos and worldwide streaming.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <a
                ...
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-black hover:bg-neutral-900 active:scale-95 text-white font-black text-xs sm:text-sm uppercase tracking-wider shadow-xl transition-all cursor-pointer"
              >
              ...
              <Link
                to="/rate-card"
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-white hover:bg-gray-100 active:scale-95 text-black font-black text-xs sm:text-sm uppercase tracking-wider shadow-xl transition-all cursor-pointer border border-black/10"
              >
      ...
      {/* 2. DEDICATED RATE CARD TEASER BANNER */}
      <section className="w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto my-4">
        <div className="bg-[#121829] border border-white/10 rounded-[28px] p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-2xl">
          <div className="flex items-center gap-4 text-center sm:text-left">
            <div className="w-14 h-14 rounded-2xl bg-brand-yellow/15 flex items-center justify-center text-brand-yellow shrink-0">
              <Sparkles className="w-7 h-7" />
            </div>
            <div>
              <span className="text-[11px] font-black uppercase tracking-widest text-brand-yellow block">
                OFFICIAL STATION PRICING
              </span>
              <h3 className="text-xl sm:text-2xl font-black uppercase text-white font-display">
                Looking for Specific Airplay Rates?
              </h3>
              <p className="text-xs sm:text-sm text-gray-400 font-medium max-w-xl">
                Check our official transparent rate card for Live Appearances, Programmes Sponsorship, On-air Hypes, Studio Charges, and Announcements.
              </p>
            </div>
          </div>
          ...
          <Link
            to="/rate-card"
            className="px-8 py-3.5 rounded-full bg-brand-yellow hover:bg-brand-yellowHover text-black font-black text-xs sm:text-sm uppercase tracking-wider shadow-lg transition-all shrink-0 flex items-center gap-2 cursor-pointer active:scale-95"
          >
      ...
      {/* 3. "HOW IT WORKS" & BESPOKE PACKAGES SECTION (Photo Background) */}
      ...
      {/* 4. "WHY ADVERTISE WITH US?" & "STILL HAVE DOUBTS?" */}
      <section className="w-full py-8 sm:py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
