...
export const ContactPage: React.FC = () => {
  ...
  return (
    <div className="w-full select-none pb-24 font-sans space-y-16 sm:space-y-24">
      ...
      <div id="contact-hero" className="w-full relative overflow-hidden bg-[#0C0D10] border-b border-white/5 pt-8 pb-16 sm:pt-12 sm:pb-24">
        ...
        <div className="absolute inset-0 z-0">
          <img
            ...
            alt="Imole 106.3 FM Broadcast Complex Fadeyi Lagos"
        ...
        <div className="absolute bottom-4 left-0 right-0 flex items-center justify-center pointer-events-none z-0 overflow-hidden select-none">
          <span
            className="font-black text-[18vw] text-transparent tracking-tighter uppercase font-display leading-none whitespace-nowrap opacity-25"
            style={{
        ...
        {/* Container for Header & Side-by-Side Contact Cards */}
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-8 sm:space-y-10">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              <div className="flex items-center gap-2 text-xs text-brand-yellow font-extrabold uppercase tracking-widest mb-2">
                ...
                <span>Station Central Hub • Broadcast Complex Fadeyi</span>
              </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              onClick={() => scrollToSection('contact-cards')}
          ...
          {/* 2-Column Hero Cards (White Info Card + Dark Form Card) over Imole Building Image */}
          <div id="contact-cards" className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 items-start justify-center pt-2">
                ...
                <form onSubmit={handleContactSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#D4D4D8] text-black px-4 py-2.5 rounded-lg text-xs sm:text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-brand-yellow shadow-inner"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#D4D4D8] text-black px-4 py-2.5 rounded-lg text-xs sm:text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-brand-yellow shadow-inner resize-none"
                    />
                  </div>
      ...
      {/* ========================================================================= */}
      {/* 2. OFFICIAL CALL IN STUDIO BANNER                                         */}
      {/* ========================================================================= */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 bg-[#141416] rounded-3xl p-8 sm:p-10 border border-white/10 shadow-2xl flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-5 text-gray-200 text-sm sm:text-base leading-relaxed">
              ...
              <p className="border-l-4 border-white/20 pl-4 sm:pl-5">
              ...
              <p className="border-l-4 border-brand-yellow pl-4 sm:pl-5 text-gray-300">
          ...
          <div className="lg:col-span-5 bg-[#141416] rounded-3xl overflow-hidden border border-white/10 shadow-2xl flex flex-col justify-between relative group">
            ...
            <div className="p-6 space-y-2">
              <h4 className="text-lg font-black text-white uppercase font-display">
                Imole Broadcast House
              </h4>
              <p className="text-xs text-gray-400 leading-relaxed">
                20, Adetoro John Street, Fadeyi, Lagos — home to state-of-the-art digital broadcast studios, live on-air suites, and modern audio production facilities.
              </p>
              <a
                href={STATION_INFO.googleMapsUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 text-xs font-black text-brand-yellow hover:underline pt-1 cursor-pointer"
              >
