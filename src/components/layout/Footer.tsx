...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-[#060D24] text-white pt-12 sm:pt-16 pb-12 select-none border-t border-blue-900/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="md:col-span-6 lg:col-span-7 bg-brand-yellow text-black p-8 sm:p-10 flex flex-col justify-between relative z-10">
            ...
            <div className="space-y-3.5">
              ...
              <div className="flex items-center gap-3 font-bold text-sm sm:text-base text-black">
                ...
                <a href="tel:09022000085" className="hover:underline font-black">
                  09022000085
                </a>
              </div>
              ...
              <div className="pt-2 space-y-1.5">
                <span className="text-[10px] font-black uppercase tracking-wider text-black/80 block">
                  FOLLOW US @IMOLEFMLAGOS
                </span>
                <div className="flex items-center gap-2.5">
                  <a
                    ...
                    aria-label="Facebook - @IMOLEFMLAGOS"
                  >
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="w-9 h-9 rounded-full bg-black text-brand-yellow hover:scale-110 active:scale-95 flex items-center justify-center transition-transform shadow-md"
                    aria-label="Instagram - @IMOLEFMLAGOS"
                  >
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="w-9 h-9 rounded-full bg-black text-brand-yellow hover:scale-110 active:scale-95 flex items-center justify-center transition-transform shadow-md"
                    aria-label="Twitter / X - @IMOLEFMLAGOS"
                  >
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  ...
                  <a
                    href="https://youtube.com/@imolefmlagos"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-9 h-9 rounded-full bg-black text-brand-yellow hover:scale-110 active:scale-95 flex items-center justify-center transition-transform shadow-md"
                    aria-label="YouTube - @IMOLEFMLAGOS"
                  >
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
        ...
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 pt-4">
          ...
          <div className="bg-[#0F204E] rounded-2xl p-3 sm:p-4 flex items-center gap-3 border border-blue-900/40 shadow-xl">
            <div className="w-12 h-12 rounded-xl overflow-hidden bg-[#060D24] shrink-0 border border-white/10">
              <img
