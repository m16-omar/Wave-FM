...
export const PRESENTERS_DATA: PresenterItem[] = [
  {
    ...
    fullBio: 'Mia Johnson is WAVE 98’s resident tastemaker and the magnetic voice behind Hitmakers Live. With a decade of club and festival appearances across London, Ibiza, and Berlin, Mia seamlessly blends chart-topping urban anthems with exclusive underground white labels.',
    rating: 5,
  ...
  },
  {
    ...
    fullBio: 'Alex Rivera founded WAVE 98 with a singular mission: pure music authenticity, live community engagement, and celebrating the power of radio.',
    rating: 5,
